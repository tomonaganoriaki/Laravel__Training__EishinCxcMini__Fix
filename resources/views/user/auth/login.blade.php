...
.title{
        ...
        <div>
            ...
            @else
                @if (Route::has('user.register'))
                    <a class="underRegister" href="{{ route('user.register') }}" ><p class="register" >新規登録</p></a>
                @endif
            @endauth
        </div>
    @endif
    ...
    <div class="buttonFlex">
        <a href="http://127.0.0.1:8000/owner/login">Ownerログインはこちら</a>
