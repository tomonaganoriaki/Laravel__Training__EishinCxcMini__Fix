                ...
                <div class="p-6 text-gray-900">
                    <div class="p-6">
                       ...
                       @foreach ($products as $product)
                                ...
                                <div class="block" >
                                    <div class=" rounded-md p-4 marginB10  borderLine">
                                        <div class="text-xl">
                                            <div class="paddingBottom15 ">  
                                                <div class="flex justify-between">
                                                    ...
                                                    <section class="accordion">
                                                        ...
                                                        <label class="Label" for="{{ $loop->index + 1 }}">応募</label>
                                                        <div class="content">
                                                            <p class="text">本当に応募しますか？</p>
                                                            <form method="post" action="{{ route('user.cart.add') }}">
                                                                @csrf
                                                                <button class="flex ml-auto  bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded addButton">応募</button>
